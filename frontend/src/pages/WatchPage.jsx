...
import WatchScreenSkeleton from "../components/skeletons/WatchScreenSkeleton";
  ...
  return (
    <div className="bg-black min-h-screen text-white">
      <div className="mx-auto container px-4 py-8 h-full">
        ...
        <div className="aspect-video mb-8 p-2 sm:p-10 md:p-32">
          {trailers.length > 0 && (
            <ReactPlayer
              controls={true}
              width={"100%"}
              height={"70vh"}
              className="mx-auto overflow-x-visible rounded-lg"
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-20">
          <div className="mb-4 md:mb-0">
            ...
            <p className="mt-2 text-lg">
              {formatReleaseDate(
                content?.release_date || content?.first_ait_date
              )}{" "}
              |{" "}
              {content?.adult ? (
