...
const AuthScreen = () => {
  ...
  return (
    <div className="hero-bg relative">
      ...
      {/* Hero Section */}
      <div className="max-w-6xl mx-auto flex flex-col items-center justify-between text-center text-white py-40">
      ...
      <div className="py-10 bg-black text-white">
        <div className="flex max-w-6xl mx-auto items-center justify-center flex-col-reverse md:flex-row px-4 md:px-2">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-lg md:text-xl">
              Send kids n adventures with their favorite characters in a space
